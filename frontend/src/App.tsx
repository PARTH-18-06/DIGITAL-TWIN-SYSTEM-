...
import { DigitalTwinPlaceholder } from './components/DigitalTwinPlaceholder'
...
export default function App() {
  ...
  const [forecast, setForecast] = useState<ForecastResponse | null>(null), [risk, setRisk] = useState<RiskResponse | null>(null), [visualizationState, setVisualizationState] = useState('')
